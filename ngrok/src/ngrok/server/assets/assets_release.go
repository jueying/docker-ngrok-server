...
func assetsServerTlsSnakeoilCrt() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/server/tls/snakeoil.crt", size: 1809, mode: os.FileMode(420), modTime: time.Unix(1522753376, 0)}
...
func assetsServerTlsSnakeoilKey() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/server/tls/snakeoil.key", size: 3243, mode: os.FileMode(420), modTime: time.Unix(1522753376, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
